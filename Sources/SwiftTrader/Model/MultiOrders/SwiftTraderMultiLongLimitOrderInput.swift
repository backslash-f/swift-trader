...
/// Encapsulates all the arguments required for submiting multiple long limit orders at once to supported exchanges.
public struct SwiftTraderMultiLongLimitOrderInput {
    ...
    ///   - priceIncrement: How much the price of subsequent orders (second, third, fourth, and fifth)
    ///   should go **up**.
