    ...
    func handle(networkRequestError: NetworkRequestError, operation: SwiftTraderOperation) -> SwiftTraderError {
        ...
        default:
            let operationErrorDictionary: [SwiftTraderOperation: (NetworkRequestError) -> SwiftTraderError] = [
                ...
                .kucoinSpotHFPlaceMultiLongLimitOrders: SwiftTraderError.kucoinSpotHFPlaceMultiLongLimitOrders,
                .kucoinSpotHFPlaceMultiShortLimitOrders: SwiftTraderError.kucoinSpotHFPlaceMultiShortLimitOrders,
